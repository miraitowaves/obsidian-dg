...
卷积层的感受野定义为一个像素在卷积前对应的区域 例如3_3、步长为1的卷积核对应感受野3_3、嵌套2次对应感受野是5*5

1. 3*3、步长为1，求嵌套3次对应感受野是多少
2. 3*3、步长为2，求嵌套2次对应感受野是多少
3. 在输入和输出图片的深度都是10的情况下，分别求上面两题的卷积核 以及“7*7、步长为1，不嵌套的卷积核”，这三种卷积核的参数数据量
